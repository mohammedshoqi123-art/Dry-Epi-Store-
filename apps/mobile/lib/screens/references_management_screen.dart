    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => Directionality(
        ...
        child: AlertDialog(
          ...
          content: Text('هل أنت متأكد من حذف "${ref['title_ar']}"؟',
              style: const TextStyle(fontFamily: 'Tajawal')),
          actions: [
            TextButton(
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(_categories[category] ?? category,
                              style: const TextStyle(
                                  fontFamily: 'Tajawal',
                                  fontSize: 11,
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(_getCategoryIcon(ref['category'] ?? 'other'),
            ...
            _actionTile(
                Icons.delete_forever_rounded, 'حذف', AppTheme.errorColor, () {
              Navigator.pop(ctx);
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      _inputDecoration('العنوان (عربي) *', Icons.title_rounded),
                ...
                TextFormField(
                  ...
                  decoration: _inputDecoration(
                      'العنوان (إنجليزي)', Icons.title_rounded),
                  style: const TextStyle(fontFamily: 'Tajawal'),
                ),
                const SizedBox(height: 14),
                TextFormField(
                  ...
                  maxLines: 3,
                  decoration:
                      _inputDecoration('الوصف', Icons.description_rounded),
                  style: const TextStyle(fontFamily: 'Tajawal'),
                ),
                const SizedBox(height: 14),
                DropdownButtonFormField<String>(
                  ...
                  decoration:
                      _inputDecoration('التصنيف', Icons.category_rounded),
                ...
                TextFormField(
                  ...
                  decoration: _inputDecoration(
                      'رابط الملف (اختياري)', Icons.link_rounded),
                  style: const TextStyle(fontFamily: 'Tajawal'),
                ),
                const SizedBox(height: 20),
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(
                        ...
                        color: Colors.white),
                    label: Text(_isEditing ? 'حفظ التعديلات' : 'إضافة المرجع',
                        style: const TextStyle(
                            fontFamily: 'Tajawal',
                            fontWeight: FontWeight.w600,
                            color: Colors.white)),
